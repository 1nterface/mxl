...
class alta_costos_caja extends StatefulWidget {
  ...
  @override
  alta_costos_cajasta createState() => alta_costos_cajasta();
}

class alta_costos_cajasta extends State<alta_costos_caja> {


  @override
  void dispose() {
   //BORRAR EMPRESA DESPUES DE SALIR DE PANTALLA, POR QUE SE QUEDA GRABADA
