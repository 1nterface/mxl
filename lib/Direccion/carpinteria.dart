...
import 'package:mxl/Direccion/carpinteria_producto_detalle.dart';
import 'package:mxl/Direccion/carpinteria_producto_detalle.dart';
...
class carpinteriaState extends State<carpinteria> {
                          ...
                          child: SizedBox(
                            child: RaisedButton(
                              ...
                              onPressed: () async {
                                ...
                                Toast.show("¡Tiempo de espera modificado!", duration: Toast.lengthLong, gravity:  Toast.center);
  ...
  final _formKeyMotivo = GlobalKey<FormState>();

  void _cancelarPedido (BuildContext context, String newid) {
          ...
          content: Form(
            ...
            child: Container(
              ...
              child: TextFormField(
                validator: (text) {
                  if (text == null || text.isEmpty) {
                    return 'No puedes cancelar sin ingresar motivo';
                  }
                  return null;
                },
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                if (text == null || text.isEmpty) {
                  return Toast.show("No puedes cancelar sin ingresar motivo", duration: Toast.lengthLong, gravity:  Toast.center);
                }
                else{
  ...
  Future<void> sonidoNuevoPedido(){
    return FlutterBeep.beep(false);
  }
  ...
  listaPorAceptar(){
    ...
    return Expanded(
      child: StreamBuilder(
        //Asi encontraremos los negocios por ciudad y sin problemas con la BD
          stream: reflistaproduccion.where('estadoc', isEqualTo: "Pedido en espera").where('correoNegocio', isEqualTo: correo).where("miembrodesde", isEqualTo: '${now.year}-${now.month}-${now.day}').orderBy('folio', descending: true).snapshots(),
              ...
              return ListView(
                children: snapshot.data!.docs.map((documents) {
                  ...
                  return InkWell(
                    ...
                    onLongPress:(){
                      _cancelarPedido(context, documents["newid"]);
                    },
                    onTap: () async{
  ...
  listaProgreso(){
    ...
    return Expanded(
      child: StreamBuilder(
        //Asi encontraremos los negocios por ciudad y sin problemas con la BD
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('estadoc', isEqualTo: "En progreso").where("miembrodesde", isEqualTo: '${now.year}-${now.month}-${now.day}').orderBy('folio', descending: true).snapshots(),
          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot){
            if (!snapshot.hasData) {
              return Text("Loading..");
            }
  ...
  listaPorFinalizar(){
    ...
    return Expanded(
      child: StreamBuilder(
        //Asi encontraremos los negocios por ciudad y sin problemas con la BD
          stream: reflistaproduccion.where('correoNegocio', isEqualTo: correo).where('estadoc', isEqualTo: "Finalizado").where("miembrodesde", isEqualTo: '${now.year}-${now.month}-${now.day}').orderBy('folio', descending: true).snapshots(),
          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot){
            if (!snapshot.hasData) {
              return Text("Loading..");
            }
                          ...
                          child: Padding(
                            ...
                            //    child: ListTile(
                                //onTap: (){
                                      ...
                                      //},
                                      //leading: Icon(Icons.motorcycle, color: Colors.yellow[800]),
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Icon(Icons.add_photo_alternate_outlined, color: Colors.yellow[800]),
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Icon(Icons.monetization_on_outlined, color: Colors.yellow[800]),
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Icon(Icons.announcement, color: Colors.yellow[800]),
              ...
              Expanded(
                child: Column(
                    children: [
                      ...
                      listaProgreso(),
                      SizedBox(height: 10),
                      Text("Finalizado", style: TextStyle(fontWeight: FontWeight.bold),),
                      listaPorFinalizar(),
                    ]
                ),
              ),
