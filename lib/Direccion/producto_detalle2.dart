                          ...
                          child: SizedBox(
                            child: RaisedButton(
                              ...
                              onPressed: () async {
                                ...
                                Toast.show("¡Existencia modificada!", duration: Toast.lengthLong, gravity:  Toast.center);
                          ...
                          child: SizedBox(
                            child: RaisedButton(
                              ...
                              onPressed: () async {
                                ...
                                _exis.clear();
                                Toast.show("¡Listo!", duration: Toast.lengthLong, gravity:  Toast.center);
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                        ...
                        child: Icon(Icons.edit, color: Colors.yellow[800])),
                    InkWell(
                      onTap: (){
                        showDialog(context: context, builder: (BuildContext context) =>  _buildAboutDialog3(context));
                      },
                      child:Text("\$"+widget.product.costoProducto.toString(), style: TextStyle(color: Colors.yellow[800], fontWeight: FontWeight.bold, fontSize: 30),),
                    ),
                  ],
                ),
