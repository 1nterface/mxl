...
class direccion_registro_nuevoState extends State<direccion_registro_nuevo> {
  ...
  var entrada = 5, salida = 12, minutos =00;
  ...
  Widget categoria(BuildContext context){
    return DropdownButton<String>(
        ...
        value: categorr,
        items: <String>["Americana", "Mexicana", "Sushi", "Alitas", "Italiana"].map((String value) {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: <Widget>[
                Icon(Icons.location_city, color: Colors.yellow[800]),
                SizedBox(width: 15),
                categoria(context),
                //Text('Medidas: 5A'),
              ],
              ...
              children: [
                GestureDetector(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Icon(Icons.more_time, color: Colors.yellow[800]),
                      SizedBox(width: 15),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.directions_car_rounded, color: Colors.yellow[800]),
                Expanded(
                  child: Column(
                    children: text
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.add_location_sharp, color: Colors.yellow[800]),
                Expanded(
                  child: Column(
                    children: text2
                        .map((t) => CheckboxListTile(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.attach_money, color: Colors.yellow[800]),
                Expanded(
                  child: Column(
                    children: textefe
                        .map((t) => CheckboxListTile(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(Icons.credit_card, color: Colors.yellow[800]),
                Expanded(
                  child: Column(
                    children: texttar
                        .map((t) => CheckboxListTile(
