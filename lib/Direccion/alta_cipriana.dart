...
class alta_ciprianaState extends State<alta_cipriana> {
  ...
  FirebaseStorage storage = FirebaseStorage.instanceFor(bucket: "gs://repartamos-afd0f.appspot.com");
  ...
  Future uploadImageToFirebase(BuildContext context) async {
    ...
    TaskSnapshot taskSnapshot = await uploadTask.whenComplete(() => Navigator.of(context).pushNamedAndRemoveUntil('/catalogo_cipriana', (route) => false));
