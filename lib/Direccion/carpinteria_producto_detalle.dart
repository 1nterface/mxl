...
import 'package:mxl/Direccion/bottom_navVentaFinal.dart';
import 'package:mxl/Direccion/gerencia_home_sheet.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter_speed_dial/flutter_speed_dial.dart';
import 'package:mxl/Direccion/gerencia_home.dart';
import 'package:mxl/Direccion/gerencia_home_sheet.dart';
import 'package:mxl/Direccion/producto_detalle2.dart';
...
class carpinteria_producto_detalleState extends State<carpinteria_producto_detalle> {
  ...
  //HAY PROBLEMAS SOLO EN LISTA "POR ACEPTAR" EN TOTALNOTA
            ...
            children: [
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children:[
                              ...
                              Column(
                                children: [
                                  Text('Para recoger', style: TextStyle(color: Colors.yellow[800],fontSize: 35, fontWeight: FontWeight.bold)),
                                  SizedBox(
                                      width: 350,
                                      child: Text(widget.product.nombreProducto, style: TextStyle(color: Colors.yellow[800], fontSize: 25), textAlign: TextAlign.center)),
                                ],
                              )
                                  :
                              Column(
                                children: [
                                  Text('Tu pedido', style: TextStyle(color: Colors.yellow[800],fontSize: 35, fontWeight: FontWeight.bold)),
                                  Text(widget.product.foto, style: TextStyle(color: Colors.yellow[800],fontSize: 20)),
                                ],
                              ),
                        ...
                        Padding(
                          ...
                          child: Text(widget.product.codigoDeBarra, style: TextStyle(fontSize: 25, color: Colors.yellow[800])),
                        )
                            :
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text('Subtotal: ', style: TextStyle(color: Colors.yellow[800], fontSize: 20.0),),
                                  subtotal(context),
                                ],
                              ),
                              SizedBox(height:10),
                              Row(
                                ...
                                children: [
                                  Text('Servicio A Dom.: ', style: TextStyle(color: Colors.yellow[800], fontSize: 20.0),),
                              ...
                              Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children:[
                                    Text('Total: ', style: TextStyle(color: Colors.yellow[800], fontSize: 40.0, fontWeight: FontWeight.bold),),
                                    total(context),
                                  ]
                              ),
                            ],
              ...
              Column(
                ...
                children: [
                  ...
                  //SI ESTADOC ES IGUAL A "PEDIDOENESPERA", MOSTRAR BOTON "PREPARAR" Y CAMBIAR ESTADOC A "EN PROGRESO"
                  //SI ESTADOC ES IGUAL A "EN PROGRESO", MOSTRAR BOTON "FINALIZADO" Y CAMBIAR ESTADOC A "FINALIZADO".
                  // SI ESTADOC ES IGUAL A "FINALIZADO", MOSTRAR BOTON "ENTREGAR" Y CAMBIAR ESTADOC A "ENTREGADO".
                  //SI ES A DOMICILIO AGREGAR FLETE, MISMOS ESTADOS.

                  widget.product.fecha == "Pedido en espera"?
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Container(
                  ...
                  :
                  widget.product.fecha == "En progreso"?
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Container(
                        child: SizedBox(
                          ...
                          child: RaisedButton(
                            color: Colors.yellow[800],
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0)),
                            child: Text('Finalizado', style: TextStyle(color: Colors.white,fontSize: 30.0),),
                            onPressed: () async {
                  ...
                  :
                  widget.product.fecha == "Finalizado"?
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Container(
                        child: SizedBox(
                          ...
                          child: RaisedButton(
                            color: Colors.yellow[800],
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30.0)),
                            child: Text('Entregar', style: TextStyle(color: Colors.white,fontSize: 30.0),),
                            onPressed: () async {
                              ...
                              Navigator.of(context).pop(); //Te regresa a la pantalla anterior
                              Navigator.of(context).pop(); //Te regresa a la pantalla anterior
                              //HACER UN MODEL CLASS PARA PASAR COMO PARAMETRO EL #2 Y QUE EL EL MODEL CLASS VALGA #0 SIEMPRE
                              //CADA QUE PASE POR AQUI, VA A ENVIAR EL #2 Y ASI SE CAMBIARA EN LA CLASE TAB, CUANDO NO PASE
                              //ESO, VALDRA #0 Y SE COLOCARA EN SU TAB ORIGINAL QUE ES EL PRIMERO

                              //BUSCAR OTRA SOLUCION..
                              //await Navigator.push(context, MaterialPageRoute(builder: (context) => bottom_nav()));
                  ...
                  :
                  widget.product.fecha == "Entregado"?
                  Container()
                 :
                          ...
                          child: SizedBox(
                            child: RaisedButton(
                              ...
                              onPressed: () async {
                                ...
                                Toast.show("Tu reporte ha sido enviado\n¡Nos comunicaremos contigo a la brevedad!", duration: Toast.lengthLong, gravity:  Toast.center);
