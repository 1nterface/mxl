...
import 'package:mxl/Clientes/menu_cliente.dart' as menu;
import 'package:mxl/Clientes/ofertas.dart' as ofertas;

import 'package:mxl/Clientes/compras.dart' as compras;
...
class homeState extends State<home> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    print("kill "+widget.product.fecha);
    print("kill "+widget.product.nombreProveedor);
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: <Widget>[
          ...
          menu.menu_cliente(widget.product.nombreProducto, widget.product.nombreProveedor, widget.product.newid, widget.product.foto, widget.product.estado, widget.product.codigoDeBarra, widget.product.maximo, widget.product.minimo, widget.product.newid),
          ofertas.ofertas(),
          compras.compras(),
