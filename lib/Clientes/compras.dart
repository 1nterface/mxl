...
import 'package:mxl/Modelo/panel_pedido_modelo.dart';
...
class comprasState extends State<compras> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                    ...
                    children: <Widget>[
                      Text('R E P A R T I D O R E S', style: TextStyle(fontSize: 25, color: Colors.yellow[800]),),
                    ]
                ),
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        SizedBox(
                                          height: 50,
                                          width: 60,
                                          child: Icon(Icons.motorcycle, color: Colors.yellow[800], size: 35,),
                                        ),
                                        Column(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: <Widget>[
                                            Text(nombre, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Colors.yellow[800]),),
  ...
  void cronos(BuildContext context, newid){
    Future.delayed(Duration(seconds: 30), () {

      //FirebaseFirestore.instance.collection('Pedidos_Jimena').doc(newid).update({'estadoh': 'nosepuedecancelar'});
            ...
            else
            {
              ...
              return ListView(
                children: snapshot.data!.docs.map((documents) {
                  ...
                  //AGREGAR AQUI PARA CANCELAR PEDIDO ANTES DE LOS 10 MINITOS SOLAMENTE, USAR CRONOS
                  ...
                  return InkWell(
                    onLongPress: (){
                      ...
                      cronos(context, documents["newid"]);

                      documents["estadoh"] == "sepuedecancelar"?
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            SizedBox(
                                                width: 120,
                                                child: Text(documents["estado3"], textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.yellow[800]),)),
                                        ...
                                        SizedBox(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Container()
                                                  :
                                              Text(documents["repa"], style: TextStyle(color: Colors.yellow[800]), maxLines: 1, overflow: TextOverflow.fade, softWrap: false),
                                            ],
                                          ),
                                        ),
                                      ],
