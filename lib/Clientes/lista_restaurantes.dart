                  ...
                  return InkWell(
                    ...
                    onTap: () async{
                      ...
                      await Navigator.push(context, MaterialPageRoute(builder: (context) =>
                          home(cajas_modelo("", documents["empresa"], documents["tarjeta"], documents["minutosSalida"],documents["entrada"], documents["salida"],4,5,documents["numero"],documents["correo"],documents["colonia"], documents["calle"], documents["tarjeta"], 0))
                      ),);
                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      child: Text(documents["nombre"], style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22.0, color: Colors.black45),),
                                      //height: 30,
                                      width: 300,
                                    ),
                                    //SizedBox(width: 5,),
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () async{
                                ...
                                await Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                    home(cajas_modelo("", documents["empresa"],documents["miembrodesde"],documents["minutosSalida"],documents["entrada"], documents["salida"],4,5,documents["numero"],documents["correo"],documents["colonia"], documents["calle"], documents["newid"], 0))
                                ),);
                                //await Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                //AGREGAR EL TOTAL POARA PASARLO A LA SIGUIENTE PANTALLA
                                //Carpitneria_Producto_Detalle(Cajas_Modelo(null, nombreProducto,fecha,folio,2,3,4,5,"","","e","f", newid, costoproducto))
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            height: 80,
                            width: 80,
                            child: Image.asset('images/repartamos.png'),
                          ),
                        ),
                        Text('Todos'),
                      ],
